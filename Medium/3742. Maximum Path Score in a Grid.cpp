// Problem Link: https://leetcode.com/problems/maximum-path-score-in-a-grid/description/?envType=daily-question&envId=2026-04-30
...
// Time Complexity : O(M*N*K) => O(N^3);
// Space Complexity: O(M*N*K) => O(N^3);